        ...
        <div class="row">
            <div class="col-md-12 p-1 d-flex align-items-center">
                ...
                <div class="row gap-1 ml-5">
                    ...
                    <button class="my-3 btn btn-primary col-md-2"><a href="" class="nav-link text-light  my-1">All orders</a></button>
                    <button class="my-3 btn btn-primary col-md-2"><a href="" class="nav-link text-light my-1">All payments</a></button>
                    <button class="my-3 btn btn-primary col-md-2"><a href="" class="nav-link text-light my-1">List Orders</a></button>
                    <button class="my-3 btn btn-danger col-md-2"><a href="" class="nav-link text-light my-1">Log Out</a></button>
                </div>
            </div>
        </div>
        <!--fourth Child-->
